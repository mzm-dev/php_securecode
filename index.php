                ...
                <div class="col-md-4">
                    <div class="card bg-transparent border-0 m-4">
                        <div class="card-body text-warning">
                            ...
                            <h5 class="display-5 mb-3 p-2 text-center bg-warning text-dark rounded-pill">Login</h5>

                            <form action="./api.php?action=login" method="POST" novalidate>
                                ...
                                <button type="submit" name="submit" value="submit" class="w-100 btn btn-lg btn-warning mb-3">Submit</button>

                                <a href="register.php" class="w-100 btn btn-lg btn-outline-warning my-3">Register a new membership</a>
