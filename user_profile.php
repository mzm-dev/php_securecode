                ...
                <div class="col-md-4">
                    <div class="card bg-transparent border-0 m-4">
                        <div class="card-body text-warning">
                            <h5 class="display-5 mb-3 p-2 text-center bg-warning text-dark rounded-pill">Profile</h5>

                            <form action="./api.php?action=profile" method="POST" novalidate>

                                <div class="mb-3">
                                    <label for="exampleInputName1" class="form-label fs-4">Full Name</label>
                                    <input type="text" name="name" class="form-control form-control-lg" id="exampleInputName1" value="<?= $secure->xecho($data->user_name) ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label fs-4">Email address</label>
                                    <input type="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" value="<?= $secure->xecho($data->user_email) ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputRole" class="form-label fs-4">User role</label>
                                    <input type="number" min="1" max="2" name="role" class="form-control form-control-lg" id="exampleInputRole" value="<?= $secure->xecho($data->user_role) ?>">
                                </div>

                                <input type="hidden" name="token" class="form-control" value="<?php echo $_SESSION['token']; ?>">

                                <button type="submit" name="submit" value="submit" class="w-100 btn btn-lg btn-warning">Update</button>
