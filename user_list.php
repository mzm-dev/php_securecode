            ...
            <div class="col-md-12">
                <div class="card bg-transparent border-0 m-4">
                    <div class="card-body text-warning">
                        <h5 class="display-5 mb-3 p-2">User List</h5>
                        <table class="table table-hover table-warning table-bordered border-warning">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>E-mel</th>
                            ...
                            foreach ($data as $key => $data) {
                                echo "<tr>";
                                echo "<td>" . $secure->xecho($data->user_name) . "</td>";
                                echo "<td>" . $secure->xecho($data->user_email) . "</td>";
                                echo "<td>" . $secure->xecho($data->user_role) . "</td>";
                                echo "<td>";
                                if ($_SESSION['user_id'] != $data->user_id)
                                    echo '<a href="./api.php?action=delete&user=' . $secure->xecho($data->user_id) . '" class="btn btn-primary btn-icon-split btn-sm"><span class="text">delete</span></a>';
                                echo "</td>";
                                echo "</tr>";
                            }
                            ?>
